  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Typography variant="body1" paragraph>
        Welcome to Monita - the Website Uptime Monitoring System. This guide will help you get
      ...
      <Paper sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          Monita allows you to monitor the uptime and performance of your websites.
        ...
        <ol>
          ...
          <li>
            <Typography variant="body1" paragraph>
              Monita will start checking your website at the specified interval and report its status on the dashboard.
            </Typography>
          </li>
        </ol>
      </Paper>
      ...
      <Box sx={{ mb: 4 }}>
        <Accordion>
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            <Typography variant="subtitle1">How often does Monita check my websites?</Typography>
          </AccordionSummary>
          <AccordionDetails>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography variant="body1">
              Monita can send notifications via email and SMS when a website goes down or recovers.
        ...
        <Accordion>
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            <Typography variant="subtitle1">How much history does Monita retain?</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography variant="body1">
              Monita stores the complete history of all checks performed on your websites. This allows
      ...
      <Paper sx={{ p: 3 }}>
        ...
        <Typography variant="body1">
          Email: <Link href="mailto:support@Monita-example.com">support@Monita-example.com</Link>
        </Typography>
        
        <Divider sx={{ my: 2 }} />
        
        <Typography variant="body2" color="textSecondary">
          Monita Version 1.0.0 - Developed by CS Student
        </Typography>
      </Paper>
    </Box>
  );
